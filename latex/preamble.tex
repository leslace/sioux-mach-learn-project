...
\newcommand*{\titleGM}{\begingroup
	\hbox{
		...
		\parbox[b]{0.75\textwidth}{
			...
			{\noindent\LARGE\bfseries Applied Machine Learning & Predictive Modelling I: Modelling Stroke Data\\}\\[2\baselineskip]
			{\large \textbf{Authors:} Larissa Eisele, Fabian Lüthard, Yves Maillard} \\[0.5\baselineskip]
			{\large \textbf{Module:}   Applied Machine Learning & Predictive Modelling I} \\[4\baselineskip]

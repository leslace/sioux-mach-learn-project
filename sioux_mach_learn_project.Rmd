...
```
Surprisingly, we get both an accuracy and also specificity that is higher than expected for this mis-application of the linear model.
...
glm.stroke.binomial.2 <- glm(stroke ~ age + hypertension * heart_disease + bmi * avg_glucose_level,
family = "binomial",
data = df_train_linear)
...
gam.stroke <- gam(stroke ~ age + hypertension * heart_disease + bmi * avg_glucose_level,
family = "binomial",
data = df_train_linear)
summary(gam.stroke)

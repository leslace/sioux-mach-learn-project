...
```{r}
svm_model_radial <- svm(stroke ~. , data = df_train, type = "C-classification", kernel = "radial")
summary(svm_model_radial)
plot(svm_model_radial, data = df_train, bmi ~ age, slice = list(avg_glucose_level = 3))
```
